    ...
    <>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card) => (
          ...
          >
            <div className="flex gap-4 flex-col md:flex-row w-full md:w-auto items-center md:items-start">
              <motion.div
              ...
              >
                <Image
                  ...
                  src={card.src}
                  alt={card.title}
                  className="h-48 w-48 md:h-14 md:w-14 rounded-lg object-cover object-top"
                  quality={100}
                />
              </motion.div>
              <div className="">
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-black hover:text-white text-black mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
